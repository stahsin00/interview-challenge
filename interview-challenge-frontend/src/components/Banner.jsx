    ...
    return (
        <div className="w-full h-full flex justify-center items-center relative">
            ...
            <div className="z-30 absolute right-[10%] flex flex-col justify-center items-center">
                ...
                <button className="bg-[#f8ad2d] text-black p-5 rounded-lg text-2xl flex items-center font-bold hover:bg-[#d78f26] transition-colors duration-200 ease-in-out" onClick={() => {setIsFormOpen(true)}}><FaPlus className="pr-2 font-bold text-2xl"/>ADD</button>
            </div>
        </div>
    );
  }
